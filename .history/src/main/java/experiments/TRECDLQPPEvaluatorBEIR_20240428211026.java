...
public class TRECDLQPPEvaluatorBEIR {
    ...
    public static void main(String[] args) {
        ...
        try {
            OneStepRetriever retriever_train = new OneStepRetriever(Constants.QUERY_FILE_TEST, Constants.MSMARCO_INDEX);
            OneStepRetriever retriever_test = new OneStepRetriever(Constants.QUERY_FILE_TEST, corpusIndex);

            Settings.init(retriever_train.getSearcher()); // it need be changed when do test/train
