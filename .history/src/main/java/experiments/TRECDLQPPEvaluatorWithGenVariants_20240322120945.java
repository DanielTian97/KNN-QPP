...
public class TRECDLQPPEvaluatorWithGenVariants {
    ...
    static double trainAndTest(
        ...
        if(!scoreFile.equals("")){
            knnRelModel = new KNNRelModel(Constants.QRELS_TRAIN, trainQueryFile, variantsFile, variantsQidFile, scoreFile, extendToRelQueryFromDocs);
        }
        ...
        if(!scoreFile.equals("")){
            knnRelModelTest = new KNNRelModel(Constants.QRELS_TRAIN, testQueryFile, variantsFile, variantsQidFile, scoreFile, extendToRelQueryFromDocs);
        }
        ...
        try {
            ...
            */
            ...
            double kendalsOnTest = trainAndTest(args[3], retriever, targetMetric,
                    ...
                    args[0], args[1], Constants.QPP_COREL_MAX_VARIANTS, variantFile, variantQidFile, scoreFile);
            double kendalsOnTrain = trainAndTest(args[3], retriever, targetMetric,
                    QUERY_FILES[DL20], QRELS_FILES[DL20],
                    QUERY_FILES[DL19], QRELS_FILES[DL19],
                    args[1], args[0], Constants.QPP_COREL_MAX_VARIANTS, variantFile, variantQidFile, scoreFile);
