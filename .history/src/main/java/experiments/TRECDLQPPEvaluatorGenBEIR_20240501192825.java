...
public class TRECDLQPPEvaluatorGenBEIR {
    ...
    public static void main(String[] args) {
        ...
        } else if (resFileForBEIR.indexOf("webis") != -1){
        ...
        try {
            ...
            */
            ...
            double kendalsOnTest = trainAndTest(basePredictorName, targetMetric,
            ...
            double kendalsOnTrain = trainAndTest(basePredictorName, targetMetric,
                    QUERY_FILE_BEIR, QRELS_FILE_BEIR,
                    QUERY_FILE_MSMARCO, QRELS_FILE_MSMARCO,
