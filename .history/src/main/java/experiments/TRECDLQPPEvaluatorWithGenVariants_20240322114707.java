...
public class TRECDLQPPEvaluatorWithGenVariants {
    ...
    static double trainAndTest(
        ...
        if(!scoreFile.equals("")){
            knnRelModel = new KNNRelModel(Constants.QRELS_TRAIN, trainQueryFile, variantsFile, variantsQidFile, scoreFile);
        }
        ...
        if(!scoreFile.equals("")){
            knnRelModelTest = new KNNRelModel(Constants.QRELS_TRAIN, testQueryFile, variantsFile, variantsQidFile, scoreFile);
        }
